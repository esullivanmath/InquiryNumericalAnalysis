...
\author{\includegraphics[width=0.6\columnwidth, trim=0cm 6cm 0cm 8cm,
clip=true]{CoverWave.pdf} \\Eric Sullivan \\ Department of
Mathematics \\
...
\input{App04_PDE_From_Conservation.tex}
