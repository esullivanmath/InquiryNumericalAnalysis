...
\title{Numerical Methods and Modeling \\ An Inquiry-Based Approach
    \ifnum\ShowSoln=1 {\color{red} \\ {\bf Solutions}} \fi}
\date{Content Last Updated: \today}
\author{Eric Sullivan \\ Department of
Mathematics \\
Carroll College, Helena, MT \\ \texttt{esullivan@carroll.edu} \\
%     This work is licensed under
%     \href{https://creativecommons.org/licenses/by-nc-sa/4.0/}{Creative Commons:
%     NonCommercial-ShareAlike}\\
\includegraphics[width=0.6\columnwidth, trim=0cm 4cm 0cm 4cm, clip=true]{CoverWave.pdf} \\
