...
\begin{problem}
    ...
    that a function $f(x)$ that {\it best} fits this data is quadratic then $f(t) = ax^2 +
    bx + c$ for some constants $a$, $b$, and $c$.  
    \begin{enumerate}
        \item[(a)] Plot the four points along with the function $f(t)$ for arbitrarily
...
\begin{challenge}[modified from \cite{Chartier}]
